  ...
  return (
    <Card className="mt-6">
      ...
      <CardBody>
        <div className="grid grid-cols-1 md:grid-cols-[1fr_180px_auto] gap-3 items-end">
          ...
          <div>
            ...
            <select
              ...
              className="h-10 w-full rounded-lg border border-[var(--border)] bg-[var(--card)] text-[var(--text)] px-3 text-[13px]"
            >
        ...
        {status.kind === "success" && (
          <div className="mt-3 text-[12px] text-[var(--green)]">
            {t("team.invite.success", lang, { email: status.email })}
          </div>
        )}
        {status.kind === "error" && (
          <div className="mt-3 text-[12px] text-[var(--red)]">
            {status.message}
          </div>
        )}
      </CardBody>
